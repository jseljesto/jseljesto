...
public class TeamViewer {
  ...
  public TeamViewer (int num, String fn, String sn, ImageView nt, int age, String pos, int avg, int pot, int lonn, int verdi) {
    this.kitNumber = num;
    this.firstName = fn;
    this.surName = sn;
    this.nation = nt;
   ...
   */
  public void setNation(ImageView nation) {
    this.nation = nation;
  }
